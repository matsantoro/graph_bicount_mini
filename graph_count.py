...
def biedge_counts_per_dimension(conn_matrix: np.ndarray, repeats: bool = True,
                                temp_fname: str = temporary_file_name) -> Dict[int, int]:
    """
    ...
    def count_biedges_with_repeats():
        result_dict = {}
        simplices = get_simplex_list()
    ...
    def count_biedges_without_repeats():
    ...
    try:
        ...
        if repeats:
            return count_biedges_with_repeats()
        else:
            return count_biedges_without_repeats()
